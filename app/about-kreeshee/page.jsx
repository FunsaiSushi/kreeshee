    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-5xl space-y-6 text-center">
        ...
        <p className="text-lg text-gray-600">
          ...
          together farmers, traders, and consumers under one platform, providing
          a seamless marketplace for buying and selling fresh produce, renting
          trucks, warehouses, and hiring workers.
        </p>
        ...
        <section className="space-y-6">
          ...
          <p className="text-lg text-gray-600">
            ...
            effortlessly buy and sell fresh produce, access logistics services,
            and connect with professionals and experts in agriculture.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border rounded-lg p-4 shadow-lg">
              ...
              <p className="text-gray-600 mt-2">
                ...
                farmers and traders. Our platform ensures transparency, quality,
                and fair pricing for all your agricultural needs.
              </p>
            </div>
            ...
            <div className="border rounded-lg p-4 shadow-lg">
              ...
              <p className="text-gray-600 mt-2">
                Connect with agriculture or logistics professionals and experts
                to get advice, solve problems, or optimize your business
                operations.
              </p>
            </div>
          </div>
        ...
        <section className="space-y-6">
          ...
          <ul className="text-left text-gray-600 list-disc list-inside">
            ...
            <li>
              Comprehensive and user-friendly platform for all your agricultural
